...
def validate_token(token, region):
    ...
    if time.time() > claims['exp']:
        ...
        return False
    # and the Audience  (use claims['aud'] if verifying an identity token)
...
class AuthPolicy(object):
    awsAccountId = ""
    """Placeholder for the AWS account id the policy will be generated for. This is used to create the method ARNs."""
    principalId = ""
    """Placeholder for the principal used for the policy, this should be a unique identifier for the end user."""
    version = "2012-10-17"
    ...
    restApiId = "<<restApiId>>"
    """ Placeholder for the API Gateway API id to be used in the policy. 
    Beware of using '*' since it will not simply mean any API Gateway API id, because stars will greedily expand over '/' or other separators. 
    See https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_resource.html for more details. """

    region = "<<region>>"
    """ Placeholder for the region to be used in the policy. 
    Beware of using '*' since it will not simply mean any region, because stars will greedily expand over '/' or other separators. 
    See https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_resource.html for more details. """

    stage = "<<stage>>"
    """ Placeholder for the stage to be used in the policy. 
